...
```{r}
# Read in data
train <- read.csv("../Raw Data/train.csv")
test <- read.csv("../Raw Data/test.csv")
...
bad_words <- read.table("../Raw Data/dictionaries/bad-words.txt") # https://www.cs.cmu.edu/~biglou/resources/bad-words.txt
bad_words_2 <- read.table("../Raw Data/dictionaries/badwords.txt") # https://code.google.com/archive/p/badwordslist/downloads
bad_words_3 <- read.table("../Raw Data/dictionaries/list.txt") # https://github.com/RobertJGabriel/Google-profanity-words/blob/master/list.txt
